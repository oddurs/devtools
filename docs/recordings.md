...
| -------------------- | ------- | ----------------- | ---------- | ------------------------- | ------------------------------------------------------------------------------- |
| screenshots (today)  | no      | at one size       | no         | no, baked in              | ~100 KB each                                                                    |
...
| turborust, brevity, triblenka, knit, polkadot, fontina, clackson |               |                                      |                   | story first, or keep the typed session                                                                                                                                                                                                    |
