...
| windsor                           | ✓             | ✓ 2026-09-22, main                   | keys              | 24 s in a 46-row terminal: spec, watching it run and opening the throttle, the dyno, verify. Two takes for the sound view (`samples`)                                                                                                     |
| cornell                           | ✓             | ✓ 2026-09-22, main                   |                   | 20 s in a 49-row terminal: the metals, a render, a spectrum, verify. Three renders for the gallery (`renders`), about five minutes of fixture                                                                                             |
